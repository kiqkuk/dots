...
# list) will work.
# Type: List of String
c.qt.args = ['force-dark-mode', 'enable-gpu-rasterization', 'enable-oop-rasterization', 'enable-accelerated-video-decode']
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/bal/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/bal/.local/share/qutebrowser/userscripts/*')
