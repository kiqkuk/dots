...
- **Modular Bash:**  
Decoupled my config into env, completions, aliases, and prompt. They all meet in the main config file. Just make sure your **Bash can see the main config** and you're good.
